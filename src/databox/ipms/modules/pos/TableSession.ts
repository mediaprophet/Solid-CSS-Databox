...
const CMS_CONTEXT = 'urn:solid-server:databox:ipms#';
const POS_CONTEXT = 'urn:solid-server:databox:ipms:pos#';
...
export const TABLE_SESSION_MODULE_MANIFEST: SolidModuleManifest = {
  ...
  capabilities: [
    ...
    'pos:wifi-onboarding',
    'ipms:portable-core-pos-table-session',
    'ipms:css-enhanced-table-session-store',
  ],
  routes: [
    'POST /.databox/ipms/pos/tables/sessions',
    'POST /.databox/ipms/pos/tables/sessions/close',
    'GET /.databox/ipms/pos/tables/sessions',
    'POST /.databox/ipms/pos/wifi-onboarding',
    'GET /.databox/ipms/pos/wifi-onboarding',
  ],
  configShape: `${IPMS.namespace}TableSessionConfigShape`,
  adminUi: {
...
function tableSessionSubject(sessionId: string): string {
  return `urn:solid-server:databox:ipms:pos:table-session:${encodeURIComponent(sessionId)}`;
}
