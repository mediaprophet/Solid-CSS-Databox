...
import { errorStatusCode, isRecord, readJsonBody, readPersistedResource, writeJson } from '../../IpmsHttpUtils';
...
export function registerPosRoutes(
  router: IpmsModuleRouter<(input: HttpHandlerInput) => Promise<void>>,
