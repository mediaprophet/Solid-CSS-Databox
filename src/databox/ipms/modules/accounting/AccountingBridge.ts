...
/**
 * Export input — converts IPMS data to accounting package format.
 */
...
/**
 * Export IPMS data to an accounting package format.
 */
...
/**
 * Import data from an accounting package into IPMS format.
 */
