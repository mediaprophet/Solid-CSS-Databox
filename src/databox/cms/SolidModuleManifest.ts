/**
 * The admin-shell surface a CMS module contributes when enabled.
 */
...
/**
 * A self-describing manifest for a CMS module — the WordPress-plugin-header analogue
 * (see `databox/solid-cms-plan.md`, §5.1). It is kept purely declarative so it can live
...
export interface SolidModuleManifest {
  ...
  /** Control-plane sub-routes (relative to the CMS base) this module mounts. */
