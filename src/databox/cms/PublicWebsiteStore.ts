...
export class PublicWebsiteStore {
   ...
   *
   * These are the SEO/discovery assets (see `databox/solid-cms-plan.md`, §10.7 / §10.8): the sitemap
   * lists the public pages for crawlers, and robots.txt advertises the sitemap while disallowing the
   * CMS control plane. Both are written at their canonical public paths (`/sitemap.xml`, `/robots.txt`)
