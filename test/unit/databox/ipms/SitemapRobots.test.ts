...
} from '../../../../src/databox/ipms/modules/website/SitemapRobots';
...
describe('SITEMAP_ROBOTS_MODULE_MANIFEST', (): void => {
  it('declares a portable-core module with no CSS-enhanced routes.', (): void => {
    ...
    expect(SITEMAP_ROBOTS_MODULE_MANIFEST.capabilities).toContain('ipms:portable-core-xml');
  });
});
...
describe('renderRobots', (): void => {
  it('renders a robots.txt that allows all agents, disallows the IPMS control plane, ' +
    ...
    expect(render.text).toContain('Disallow: /.databox/ipms');
