...
} from '../../../../../../src/databox/ipms/modules/website/CustomerDisplayRenderer';
import { renderCustomerDisplay } from '../../../../../../src/databox/ipms/modules/website/CustomerDisplayRenderer';
...
describe('renderCustomerDisplay', (): void => {
  ...
  it('rejects a protected display route.', (): void => {
    expect((): CustomerDisplayRender => renderCustomerDisplay({
      ...baseInput,
      publicPath: '/.databox/ipms/customer-display',
  ...
  it('rejects a protected asset route.', (): void => {
    expect((): CustomerDisplayRender => renderCustomerDisplay({
      ...baseInput,
      assetPaths: {
        cssPath: '/.databox/ipms/customer-display.css',
      },
    })).toThrow('CSS path must not be under the protected IPMS control plane');
  });
