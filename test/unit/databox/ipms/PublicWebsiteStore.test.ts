...
import { renderPublicWebsiteFeed } from '../../../../src/databox/ipms/modules/website/PublicFeedRenderer';
...
describe('A PublicWebsiteStore', (): void => {
  ...
  it('publishes each present asset at its own IRI with the right content type.', async(): Promise<void> => {
    ...
    expect(jsonLd['@context']).toEqual({ '@vocab': 'https://schema.org/', odrl: 'http://www.w3.org/ns/odrl/2/' });
