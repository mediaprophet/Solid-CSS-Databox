...
const validator = join(root, 'scripts', 'validate-ipms-deployment.mjs');
const tmpDir = join(root, 'test', 'tmp', 'ipms-deployment');

describe('IPMS deployment artifacts', (): void => {
  beforeEach((): void => {
  ...
  it('rejects runtime env files that still point at the example host.', (): void => {
    ...
    writeFileSync(envPath, [
      ...
      'CSS_CONFIG=config/ipms/ipms-file.json',
